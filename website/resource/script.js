...
function iframeSelect(selector) // 메뉴 선택 시 웹사이트 이동
{
  ...
  if(selector==1){ // 대시보드
    ...
    imageChange.style = 
    "background: url('icons/menuDashboard_white.png') 5% 50% no-repeat cornflowerBlue; color: white";
  }
  else if(selector==2){ // 사용자
    iframe.src = "html/user.html";
    imageChange.style = 
    "background: url('icons/menuUser_white.png') 5% 50% no-repeat cornflowerBlue; color: white";
  }
  else if(selector==3){ // 알레르기
    iframe.src = "html/allergy.html";
    imageChange.style = 
    "background: url('icons/menuAllergy_white.png') 5% 50% no-repeat cornflowerBlue; color: white";
  }
  else if(selector==4){ // 요리법
    iframe.src = "https://www.10000recipe.com/";
    imageChange.style = 
    "background: url('icons/menuHowtocook_white.png') 5% 50% no-repeat cornflowerBlue; color: white";
  }
